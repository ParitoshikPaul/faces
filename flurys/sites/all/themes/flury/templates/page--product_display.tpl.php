        ...
        <div id="carousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="item active">
                    <img src="sites/all/themes/flury/images/selection-one.png" alt="" width="462">
                </div>
                <div class="item">
                    <img src="sites/all/themes/flury/images/selection-one.png" alt="" width="462">
                </div>
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <div data-target="#carousel" data-slide-to="0" class="thumb">
                            <img src="sites/all/themes/flury/images/selection-one-thump.png" alt="" width="80">
                        </div>
...
<div class="container-fluid new-product"><!--new-product start-->
    ...
    <div class="tea-time col-lg-4 col-md-4 col-sm-4 col-xs-4">
        <!--tea-time start-->
        <div class="new-div">
            <a href="#"><img src="sites/all/themes/flury/images/product-1.jpg"></a>
            <div class="tea-hover">
                <!--tea-hover start-->
                <div class="box-div">
                    <a href="#">
